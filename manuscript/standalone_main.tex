...
% --- INLINED FROM tables/tab_cointegration_results.tex ---
\begin{table}[ht]
\centering
\small
...
\end{flushleft}
\end{table}
% --- END tables/tab_cointegration_results.tex ---
...
% --- INLINED FROM tables/tab_dh_results.tex ---
\begin{table}[ht]
\centering
\small
...
% --- INLINED FROM tables/tab_regime_breakdown.tex ---
\begin{table}[ht]
\centering
\small
...
\end{flushleft}
\end{table}
% --- END tables/tab_regime_breakdown.tex ---
...
% --- INLINED FROM tables/tab_tournament_results.tex ---
\begin{table}[ht]
\centering
\small
...
\end{flushleft}
\end{table}
% --- END tables/tab_tournament_results.tex ---
...
% --- INLINED FROM tables/tab_mcs_results.tex ---
\begin{table}[ht]
\centering
\small
...
\end{flushleft}
\end{table}
% --- END tables/tab_mcs_results.tex ---
...
% --- INLINED FROM tables/tab_robustness_grid.tex ---
\begin{table}[ht]
\centering
\small
...
\end{flushleft}
\end{table}
% --- END tables/tab_robustness_grid.tex ---
