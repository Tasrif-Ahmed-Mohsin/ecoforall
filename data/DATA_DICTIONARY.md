...
| `banking_crisis_roll5_mean` | 8,553 | `float64` | Macroeconomic GMD indicator |
...
| `central_bank_rate_roll5_mean` | 6,172 | `float64` | Macroeconomic GMD indicator |
...
| `consumption_gdp_roll5_mean` | 12,107 | `float64` | Macroeconomic GMD indicator |
...
| `cpi_roll5_mean` | 11,210 | `float64` | Macroeconomic GMD indicator |
| `cpi_delta5` | 10,501 | `float64` | Macroeconomic GMD indicator |
| `cpi_logret5` | 10,501 | `float64` | Macroeconomic GMD indicator |
...
| `currency_crisis_roll5_mean` | 8,396 | `float64` | Macroeconomic GMD indicator |
...
| `current_account_gdp_roll5_mean` | 8,705 | `float64` | Macroeconomic GMD indicator |
...
| `exports_gdp_roll5_mean` | 12,453 | `float64` | Macroeconomic GMD indicator |
...
| `fixed_investment_gdp_roll5_mean` | 11,784 | `float64` | Macroeconomic GMD indicator |
...
| `fx_to_usd_roll5_mean` | 13,449 | `float64` | Macroeconomic GMD indicator |
...
| `gdp_deflator_roll5_mean` | 12,593 | `float64` | Macroeconomic GMD indicator |
...
| `gdp_nominal_roll5_mean` | 12,832 | `float64` | Macroeconomic GMD indicator |
...
| `gdp_pc_real_roll5_mean` | 12,878 | `float64` | Macroeconomic GMD indicator |
...
| `gdp_pc_real_usd_roll5_mean` | 12,246 | `float64` | Macroeconomic GMD indicator |
...
| `gov_debt_gdp_roll5_mean` | 9,062 | `float64` | Macroeconomic GMD indicator |
...
| `gov_deficit_gdp_roll5_mean` | 9,040 | `float64` | Macroeconomic GMD indicator |
...
| `gov_expenditure_gdp_roll5_mean` | 9,300 | `float64` | Macroeconomic GMD indicator |
...
| `gov_revenue_gdp_roll5_mean` | 9,240 | `float64` | Macroeconomic GMD indicator |
...
| `gov_tax_gdp_roll5_mean` | 5,451 | `float64` | Macroeconomic GMD indicator |
...
| `imports_gdp_roll5_mean` | 12,445 | `float64` | Macroeconomic GMD indicator |
...
| `inflation_rate_roll5_mean` | 11,050 | `float64` | Macroeconomic GMD indicator |
| `inflation_rate_delta5` | 10,349 | `float64` | Macroeconomic GMD indicator |
| `inflation_rate_logret5` | 9,262 | `float64` | Macroeconomic GMD indicator |
...
| `investment_gdp_roll5_mean` | 12,134 | `float64` | Macroeconomic GMD indicator |
...
| `long_rate_roll5_mean` | 2,644 | `float64` | Macroeconomic GMD indicator |
...
| `money_supply_m1_roll5_mean` | 7,938 | `float64` | Macroeconomic GMD indicator |
...
| `money_supply_m2_roll5_mean` | 7,435 | `float64` | Macroeconomic GMD indicator |
...
| `money_supply_m3_roll5_mean` | 4,579 | `float64` | Macroeconomic GMD indicator |
...
| `population_roll5_mean` | 14,228 | `float64` | Macroeconomic GMD indicator |
...
| `real_house_price_index_roll5_mean` | 2,227 | `float64` | Macroeconomic GMD indicator |
...
| `reer_roll5_mean` | 9,745 | `float64` | Macroeconomic GMD indicator |
...
| `short_rate_roll5_mean` | 4,970 | `float64` | Macroeconomic GMD indicator |
...
| `sov_debt_crisis_roll5_mean` | 8,353 | `float64` | Macroeconomic GMD indicator |
...
| `unemployment_rate_roll5_mean` | 5,700 | `float64` | Macroeconomic GMD indicator |
| `unemployment_rate_delta5` | 5,103 | `float64` | Macroeconomic GMD indicator |
| `unemployment_rate_logret5` | 5,103 | `float64` | Macroeconomic GMD indicator |
